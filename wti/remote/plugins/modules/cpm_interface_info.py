...
- name: Get the network interface Parameters for a WTI device for all interfaces using a User Token
  cpm_interface_info:
    cpm_url: "nonexist.wti.com"
    cpm_username: ""
...
def run_module():
    ...
    fullurl = ("%s%s/api/v2%s/config/interface" % (protocol, to_native(module.params['cpm_url']),
