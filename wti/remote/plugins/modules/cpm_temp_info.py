...
- name: Get the Temperature Information of a WTI device using a User Token
  cpm_temp_info:
    cpm_url: "nonexist.wti.com"
    cpm_username: ""
...
data:
    ...
    contains:
        ...
        timestamp:
            ...
            returned: success
            type: str
            sample: "2023-02-24T20:54:03+00:00"
        status:
...
def run_module():
    ...
    fullurl = ("%s%s/api/v2%s/status/temperature" % (protocol, to_native(module.params['cpm_url']),
