...
- name: Get the network SYSLOG Client Parameters for all interfaces of a WTI device using a User Token.
  cpm_interface_info:
    cpm_url: "nonexist.wti.com"
    cpm_username: ""
...
def run_module():
    ...
    fullurl = ("%s%s/api/v2%s/config/syslogclient" % (protocol, to_native(module.params['cpm_url']),
