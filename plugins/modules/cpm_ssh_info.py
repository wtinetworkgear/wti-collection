...
short_description: Get SSH parameters that are defined in WTI OOB and PDU devices
description:
    - "Get SSH parameters that are defined in  WTI OOB and PDU devices"
options:
    cpm_url:
        description:
...
EXAMPLES = """
- name: Get the SSH parameters for a WTI device
  cpm_hostname_info:
